...
<section class="keuze">
    <div>
      <select id="chart-type" bind:value={chartType} class="chartkeuze">
    ...
    <div>
      <select id="track-limit" bind:value={trackLimit} class="chartkeuze">
    ...
    <div>
      <select id="track-term" bind:value={trackTerm} class="chartkeuze" disabled={trackType === 'recent'}>
